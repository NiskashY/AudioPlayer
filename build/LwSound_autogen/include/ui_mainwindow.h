...
public:
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        timeInfoLabel->setText(QCoreApplication::translate("MainWindow", "Last Update Time:", nullptr));
        lastUpdateTimeLabel->setText(QString());
        accountLabel->setText(QString());
        dirLabel->setText(QCoreApplication::translate("MainWindow", "Directory:", nullptr));
        standardDirLabel->setText(QString());
        changeDirButton->setText(QCoreApplication::translate("MainWindow", "Change Standard Dir", nullptr));
        addFromDeviceButton->setText(QCoreApplication::translate("MainWindow", " Add From Device ", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(likedTracks), QCoreApplication::translate("MainWindow", "Tab 1", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(downloadedTracks), QCoreApplication::translate("MainWindow", "Tab 2", nullptr));
