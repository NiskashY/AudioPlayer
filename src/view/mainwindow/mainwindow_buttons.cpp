...
void MainWindow::on_exitAccountButton_clicked() {
    if (account != nullptr) {
...
void MainWindow::on_addFromDeviceButton_clicked() {
...
void MainWindow::on_nextButton_clicked()
{
    ...
    if (!player->playlist()->isEmpty() && 
         player->playlist()->playbackMode() == QMediaPlaylist::Random) {
        srand(time(0));
